        ...
        return [
            ...
            'control_points' => [
                'day3' => [
                    ...
                    'control_at' => $this->last_disp->day3->control_at ?? null,
                ],
                'mes1' => [
                    ...
                    'control_at' => $this->last_disp->mes1->control_at ?? null,
                ],
                'mes3' => [
                    ...
                    'control_at' => $this->last_disp->mes3->control_at ?? null,
                ],
                'mes6' => [
                    ...
                    'control_at' => $this->last_disp->mes6->control_at ?? null,
                ],
                'mes12' => [
                    ...
                    'control_at' => $this->last_disp->mes12->control_at ?? null,
                ],
            ]
        ];
    }
